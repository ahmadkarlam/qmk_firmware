...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE_QWERTY_LAYER] = {
    ...
    {F(4),   S(KC_LBRC), F(14), KC_LGUI, F(0), KC_SPC, KC_SPC, F(1), KC_RGUI, F(15),  S(KC_RBRC), F(5)}
  },
  ...
  [GUI_LAYER] = {
    ...
    {_______, KC_MPRV, KC_MPLY, KC_MNXT, KC_SLCK, ___x___, ___x___, KC_SLCK,                   KC_MUTE,                KC_VOLD,             KC_VOLU,                _______}
  },
