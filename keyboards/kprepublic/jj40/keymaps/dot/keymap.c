...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_planck_2x2u(
        ...
        KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_PIPE,
        _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT,
        _______, _______, _______, _______, RAISE,       KC_LSFT,          KC_SPC,       LOWER,   _______, 
    ),
    ...
    [_LOWER] = LAYOUT_planck_2x2u(
        ...
        _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_MINS, KC_EQL,  KC_UNDS, KC_PLUS, KC_QUOT, KC_DQT,  KC_BSLS, _______,
        _______, _______, _______, _______, _ADJUST,       KC_LSFT,          KC_SPC,     _______, _______, 
    ),
    ...
    [_RAISE] = LAYOUT_planck_2x2u(
        ...
        _______, _______,   G(KC_DLR), G(KC_LBRC),   G(KC_RBRC), KC_MPLY,   KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_ENT,  _______,
        _______, _______,   _______,   _______,      _______,            KC_LSFT,           KC_SPC,    _ADJUST, _______,
    ),
    ...
    [_ADJUST] =  LAYOUT_planck_2x2u(
        ...
        _______, _______, _______, _______, _______,     KC_LSFT,            KC_SPC,      _______, _______,
    )
};
